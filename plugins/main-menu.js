...
if (pilih == "ke1") {  
conn.send3ButtonImg(m.chat, poto, zyo, ohage, 'All Menu', '.? all', 'List Menu', '.tesm', 'CariTeman', '.anonymous', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
...
if (pilih == "ke2") {
conn.send2ButtonDoc(m.chat, alok, bocil, 'All Menu', '.? all', 'CariTeman', '.anonymous', ftoko, {
			contextInfo: {
...
if (pilih == "ke4") { 
conn.sendHydrated2(m.chat, cap, wm, oh, 'https://youtu.be/9qih6F2ItUo', 'ʏ ᴏ ᴜ ᴛ ᴜ ʙ ᴇ', 'https://instagram.com/farhan_aan_01', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', [['CariTeman', `.anonymous`],
...
conn.sendHydrated2(m.chat, ucp, naru, nau, 'https://youtu.be/', 's ᴄ ʀ ɪ ᴘ ᴛ', 'https://instagram.com/farhan_aan_01', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', [['All Menu', `.? all`],
  ['List Menu', `.tesm`],['CariTeman', `.anonymous`]], m)
  }  
if (pilih == "ke7") {
...
if (pilih == "ke8") {  
conn.send3ButtonImg(m.chat, await genProfile(conn, m), aksiho, abcol, 'List Menu', '.tesm', 'Owner', '.owner', 'CariTeman', '.anonymous', m)
}
if (pilih == "ke9") { 
conn.send2ButtonImg(m.chat, await genProfile(conn, m), ucp, naru, 'All Menu', '.? all', 'Credit', '.credit', m)
}
if (pilih == "ke10") {
conn.send3ButtonImg(m.chat, zykomd, ucp, naruto,  'All Menu', '.? all', 'Speed', '.speed', 'CariTeman', '.anonymous', m)
}
}
handler.help = ['menu']
handler.tags = ['main']
